...
While congestion at the merging area (Seg. 6) and before the location of the ramp meter device (Seg. 9) should be heavily penalised, high vehicle speeds
...
\begin{table}[H]
    \centering
    \caption{Hyper-parameter settings for the RL algorithms}
